...
#SBATCH --job-name=2.1c_download_refseq_30-44 # SLURM job identifier
#SBATCH --output=../log/2.1c_download_refseq_30-44%A_%a.out
#SBATCH --error=../log/2.1c_download_refseq_30-44%A_%a.err
...
# Downloads RefSeq protein database volumes 30-44 into the configured database directory.
...
URLS=(
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.30.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.31.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.32.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.33.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.34.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.35.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.36.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.37.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.38.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.39.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.40.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.41.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.42.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.43.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.44.tar.gz"
)
