...
#SBATCH --job-name=2.1a_download_refseq_00-14.sh # SLURM job identifier
#SBATCH --output=../log/2.1a_download_refseq_00-14.sh%A_%a.out
#SBATCH --error=../log/2.1a_download_refseq_00-14.sh%A_%a.err

# SLURM email notifications are sent to the address specified below.
#SBATCH --mail-type=ALL # Enable SLURM email notifications
#SBATCH --mail-user= # email here for notifications -- I removed it as this is on a public repo.

# Downloads RefSeq protein database volumes 00-14 into the configured database directory.
...
URLS=(
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.00.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.01.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.02.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.03.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.04.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.05.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.06.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.07.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.08.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.09.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.10.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.11.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.12.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.13.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.14.tar.gz"
)
...
# This script also fetches the taxonomy DB (needed for -taxids 2 + sscinames).
if [ ! -f taxdb.btd ]; then
  echo "[$(date +%H:%M:%S)] fetching taxdb"
  wget -q "${BASE}/taxdb.tar.gz" && tar -xzf taxdb.tar.gz && rm -f taxdb.tar.gz
fi
