...
#SBATCH --job-name=2.1d_download_refseq_45-59 # SLURM job identifier
#SBATCH --output=../log/2.1d_download_refseq_45-59%A_%a.out
#SBATCH --error=../log/2.1d_download_refseq_45-59%A_%a.err
...
URLS=(
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.45.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.46.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.47.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.48.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.49.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.50.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.51.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.52.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.53.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.54.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.55.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.56.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.57.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.58.tar.gz"
  "https://ftp.ncbi.nlm.nih.gov/blast/db/refseq_protein.59.tar.gz"
)
